...
contract wTAO is ERC20, Ownable, AccessControl {
    ...
    uint256 public BITTENSOR_FEE = 25000145; // 0.01251 wTAO
    ...
    function setTransferPaused(bool _paused) public onlyOwner {
    ...
    function bridgeBack(
        ...
        // require greater than 0.01251 wTAO for gas purposes.
        require(
            _amount > BITTENSOR_FEE,
            "Does not meet minimum amount for gas (0.0125000144 wTAO)"
        );
